				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<dl>
								<dt><b class="border-bottom border-primary">Status Project</b></dt>
								<dd>
									<?php
		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Laporan Harian :</b></span>
					<?php if ($_SESSION['login_type'] != 3) : ?>
						<div class="card-tools">
							<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_task"><i class="fa fa-plus"></i> Tambah Laporan</button>
						</div>
					<?php endif; ?>
				</div>
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<b>Catatan Logbook</b>
				<div class="card-tools">
					<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> Tambah Catatan</button>
				</div>
			</div>
			<div class="card-body">
				<?php
